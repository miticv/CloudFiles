...
namespace CloudFiles
{
    public static class HttpFunctions
    {
        ...
        [OpenApiParameter(name: "from", In = ParameterLocation.Query, Required = false, Type = typeof(DateTime), Summary = "filter from creation date", Visibility = OpenApiVisibilityType.Advanced)]
        [OpenApiParameter(name: "to", In = ParameterLocation.Query, Required = false, Type = typeof(DateTime), Summary = "filter to creation date", Visibility = OpenApiVisibilityType.Advanced)]
