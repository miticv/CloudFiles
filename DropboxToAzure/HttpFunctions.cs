...
namespace CloudFiles.DropboxToAzure
{
    ...
    {
        [Function(Constants.ProcessDropboxToAzure_Start)]
        public static async Task<IActionResult> DropboxToAzureStorage(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "process/DropboxToAzure/start")] HttpRequest req,
            ...
            FunctionContext executionContext)
        {
            ...
            try
            {
                ...
                string instanceId = await starter.ScheduleNewOrchestrationInstanceAsync(
                    Constants.DropboxToAzureOrchestrator, request).ConfigureAwait(false);
