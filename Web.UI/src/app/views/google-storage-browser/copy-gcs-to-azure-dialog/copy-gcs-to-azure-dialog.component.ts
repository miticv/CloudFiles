...
export interface CopyGcsToAzureDialogData {
...
@Component({
    ...
    selector: 'app-copy-gcs-to-azure-dialog',
    styles: [`
                ...
                <div class="mb-5 p-3 rounded-lg text-sm" style="background: #e3f2fd;">
                    <div class="flex items-center gap-2">
                        ...
                        <span>
                            ...
                            from <strong>{{data.bucketName}}</strong>
                        </span>
                    </div>
                </div>
                ...
                <ng-container *ngIf="loadingStep !== 'subscriptions'">
                    ...
                    <mat-form-field *ngIf="selectedContainer && accessState === 'ready'"
                        ...
                        <input matInput [(ngModel)]="destinationFolder"
                               (ngModelChange)="onDestinationFolderChange()" placeholder="gcs-backup/2024">
                    </mat-form-field>
                </ng-container>
...
export class CopyGcsToAzureDialogComponent implements OnInit, OnDestroy {
    ...
    private static STORAGE_KEY = 'copyGcsToAzureState';

    constructor(
        private dialogRef: MatDialogRef<CopyGcsToAzureDialogComponent>,
        @Inject(MAT_DIALOG_DATA) public data: CopyGcsToAzureDialogData,
    ...
    private saveState(): void {
        sessionStorage.setItem(CopyGcsToAzureDialogComponent.STORAGE_KEY, JSON.stringify({
    ...
    private restoreState(): void {
        const raw = sessionStorage.getItem(CopyGcsToAzureDialogComponent.STORAGE_KEY);
        if (!raw) return;
    ...
    startCopy(): void {
        ...
        const selectedItems = this.data.selectedFiles.map(f => ({
            itemPath: f.itemPath,
            isFolder: f.isFolder
        }));
        ...
        forkJoin({
            ...
            switchMap(({ azureToken, googleUser, azureUser }) => {
                ...
                return this.processService.startGcsToAzure({
                    selectedItems,
