...
export function Component() {
  ...
  if (!azureConnected) {
    return <NotConnectedState provider="Azure" description="Connect your Azure account to browse storage resources." buttonLabel="Connect Azure" onConnect={() => login('azure')} />;
  }
